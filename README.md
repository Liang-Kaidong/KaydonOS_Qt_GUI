...
基于 Qt 5.12.9 开发的嵌入式车载 HMI（Human Machine Interface）桌面系统，专属适配 **正点原子 IMX6ULL-ALPHA** 开发板，适用于个人学习、教学实践、课程设计、毕业设计及非商业研究。
> ⚠️ 本项目采用 **KaydonOS Non-Commercial License v1.0** 发布，仅允许非商业用途。如需商业授权，请联系作者。
...
## KaydonOS Non-Commercial License v1.0

本项目原创源代码采用 **KaydonOS Non-Commercial License v1.0** 发布。
...
- 课程设计
- 毕业设计
- 非商业目的的修改、Fork 与二次开发（需保留原版权声明及许可证）
...
- 将本项目或其衍生作品用于任何商业用途；
- 销售、出租、授权、转售本项目或其修改版本；
- 将本项目集成到商业软件、商业产品或商业服务中；
- 基于本项目提供收费开发、收费培训、收费技术支持等营利性服务；
- 删除、修改或隐藏原作者版权声明及许可证。

如需商业授权、商业合作或定制开发，请联系作者。

完整许可协议请参阅仓库根目录 **LICENSE** 文件。

---

## 第三方资源说明

本项目可能包含或引用部分第三方资源（包括但不限于图标、图片、壁纸、音频、字体及第三方开源组件）。

除非另有说明：

- 本许可证**仅适用于本项目原创源代码**；
- 第三方资源仍受其各自版权或许可协议约束；
- 使用者应自行确认相关资源是否满足其使用场景的授权要求；
- 如第三方资源涉及商业使用，请自行获得合法授权。

如您是相关资源的版权方，并认为仓库内容存在侵权或授权问题，请联系作者，我将在核实后及时处理。
...
本许可证仅适用于本项目原创源代码，不影响第三方组件及第三方资源各自的许可协议。
